package com.letscodeit.learn.loadproperty;
...
public class LoadProperty {
    ...
    public String getProperty(String key) {
        ...
        try {
            input = new FileInputStream(projectPath + "/src/test/java/com/letscodeit/learn/resources/properties/config.properties");
